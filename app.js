...
// middleware ->  that store flash seccess and error msg...
app.use((req,res,next)=>{ 
    res.locals.success=req.flash("success");
    res.locals.error=req.flash("error");
    res.locals.currUser=req.user; // store the current users information who logged in.
...
app.listen(8080,()=>{
    console.log("server is listening on portt 8080");
});
